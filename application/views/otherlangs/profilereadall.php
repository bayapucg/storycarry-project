...
<div class="jc-m" style="display:flex; flex-wrap:wrap; justify-content:center;">
	<?php foreach($rlstories->result() as $rlstoryrow) { ?>
    	<div class="card">
        	...
        	<div class="flextest">
        		<font class="byname">By<font class="namehere">
        		    <a href="<?php echo base_url($this->uri->segment(1).'/'.$rlstoryrow->profile_name);?>" style="color:#000"> <?php echo $rlstoryrow->name;?></a></font></font>
        		<br>
        	</div>
        	<div class="flextest" style="padding-top:4px;">
               	<font class = "episodes">
    ...
    <?php foreach($rllife->result() as $rlliferow) { if($rlliferow->writing_style != 'anonymous'){ ?>
        <div class="card1">
    		...
    		<div class="flextest">
    			...
    			<?php } else { ?>
    				<font class="byname">By<font class="namehere">
    				    <a href="<?php echo base_url().$this->uri->segment(1).'/'.$rlliferow->profile_name; ?>" style="color:#000"> <?php echo $rlliferow->name;?></a></font></font>
    				<br>
    			<?php } ?>
    		</div>
    		<div class="flextest" style="padding-top:4px;">
