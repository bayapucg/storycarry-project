    ...
    <?php foreach ($profilealloadmore->result() as $valoadseriesrow) { ?>
        <div class="cardls">
			<div class="book-typels"><?php echo $valoadseriesrow->gener;?></div>
			    <a href="<?php echo base_url($this->uri->segment(1).'/series/'.preg_replace('/\s+/', '-', $valoadseriesrow->title).'-'.$valoadseriesrow->sid.'/'.preg_replace('/\s+/', '-', $valoadseriesrow->title).'-'.$valoadseriesrow->story_id);?>" class="imagesls-style">
			...
			<div>
				<font class="max-linesls">
					...
					<a href="<?php echo base_url($this->uri->segment(1).'/series/'.preg_replace('/\s+/', '-', $valoadseriesrow->title).'-'.$valoadseriesrow->sid.'/'.preg_replace('/\s+/', '-', $valoadseriesrow->title).'-'.$valoadseriesrow->story_id);?>">
    ...
    <?php foreach ($profilealloadmore->result() as $valoadstorysrow) { ?>
        <div class="cardls">
			<div class="book-typels"><?php echo $valoadstorysrow->gener;?></div>
			    <a href="<?php echo base_url($this->uri->segment(1).'/story/'.preg_replace('/\s+/', '-', $valoadstorysrow->title).'-'.$valoadstorysrow->sid);?>" class="imagesls-style">
			...
			<div>
				<font class="max-linesls">
					<a href="<?php echo base_url($this->uri->segment(1).'/story/'.preg_replace('/\s+/', '-', $valoadstorysrow->title).'-'.$valoadstorysrow->sid);?>">
        ...
        <div class="card1">
			...
			<div class="flextest" style="padding-top:4px;">
				<font class="lifeEvents-text"><?php echo mb_substr(strip_tags($valiferow->story),0,150);?> 
					<a href="<?php echo base_url($this->uri->segment(1).'/story/'.preg_replace('/\s+/', '-', $valiferow->title).'-'.$valiferow->sid);?>"></a>
				</font>
			</div>
