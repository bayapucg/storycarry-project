    			    ...
    			    <div class="mg-2">
    				    ...
    				    <?php foreach($searchresults->result() as $storyrow) { ?>
    				    	<div class="card">
        						...
        						<div class="flextest">
        							<font class="byname">By<font class="namehere">
        							    <a href="<?php echo base_url($this->uri->segment(1).'/'.$storyrow->profile_name);?>" style="color:#000"> <?php echo $storyrow->name;?></a>
        							</font>
        							</font><br>
        						</div>
        						<div class="flextest" style="padding-top:4px;">
...
<script>
    $(document).ready(function(){
        ...
        function load_country_data(limit, start) {
            ...
            if(vatype == "people"){
                $.ajax({
                    url:'<?php echo base_url().$this->uri->segment(1);?>/searchwriterloadmore?type='+vatype+'&searchtext='+vaquery,
                    method:"POST",
                ...
                $.ajax({
                    url:'<?php echo base_url().$this->uri->segment(1);?>/searchresultloadmore?type='+vatype+'&searchtext='+vaquery,
                    method:"POST",
                    data:{limit:limit, start:start},
                    cache:false,
                    success:function(data){
