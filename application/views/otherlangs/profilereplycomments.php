    ...
    <li style="margin-bottom:10px;" class="commentdelete<?php echo $proreply_comment->cid;?>">
        <div class="media">
            ...
            <div class="media-body" style="background-color:#ddd; padding-left:8px; border-radius: 10px; padding-top:5px;">
                <b><a href="<?php echo base_url().$this->uri->segment(1).'/'.$proreply_comment->profile_name;?>"><?php echo ucfirst($proreply_comment->name); ?></a></b>
                ...
                <div style="font-size:11px;"><?php echo get_ydhmdatetime($proreply_comment->date);?></div>
