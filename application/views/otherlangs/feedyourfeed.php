<?php if(isset($yourfeeds) && !empty($yourfeeds)){ ?>
    <div id="yloadmoreall">
    					...
    					<div class="box-footer box-comments editdelete<?php echo $ycomment->id;?>" style="padding-bottom:0;">
    						<div class="box-comment">
    							...
    							<div class="comment-text">
    								<div class="comment-text">
    									<span class="username" style="padding-top:6px;">&nbsp; <b><a href="<?php echo base_url().$this->uri->segment(1).'/'.$ycomment->profile_name; ?>"><?php echo ucfirst($ycomment->name);?></a></b>
    								...
    								<?php $topsubcomments = get_subcomments($yourfeed->id, $ycomment->id); 
    									...
    									<div class="media editdelete<?php echo $topsubcomment->id;?>" style="padding-left:10px;margin-top:5px;margin-bottom:5px;">
    									    ...
    									    <span class="media-body bodycv">
    								            <div class="">
    									            <span class=""><b><a href="<?php echo base_url().$this->uri->segment(1).'/'.$topsubcomment->profile_name; ?>"><?php echo ucfirst($topsubcomment->name);?></a></b><span class="dropdown" style="float:right;">
