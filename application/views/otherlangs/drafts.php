                                ...
                                <div class="dropdown  pull-right">
                					...
                					<ul class="dropdown-menu pull-right">
                    					<li class="desktopedit">
                    						...
                    						<a href="<?php echo base_url().$this->uri->segment(1);?>/series_series/<?php echo $draft->sid;?>"><i class="fa fa-edit pr-10"></i> EDIT</a>
                    						<?php }else { ?>
                    						<a href="<?php echo base_url().$this->uri->segment(1);?>/series_story/<?php echo $draft->sid;?>"><i class="fa fa-edit pr-10"></i> EDIT</a>
                    						<?php } ?>
                    					</li>
                    					<li class="mobileedit">
                    					    <?php if($draft->type == 'series') { ?>
...
<script>
    $(document).ready(function(){
        ...
        function load_country_data(limit, start) {
            $.ajax({
                url:'<?php echo base_url().$this->uri->segment(1);?>/loadmoredrafts',
                method:"POST",
...
function mobilestoryedit(sid){
    if( isMobile.Android() ) document.getElementById("apptext").innerHTML = `DOWNLOAD <a style="color:blue;" href="https://play.google.com/store/apps/details?id=com.google.android.apps.inputmethod.hindi&hl=en_IN">GOOGLE INDIC</a> KEYBOARD & <a href="<?php echo base_url().$this->uri->segment(1);?>/series_story/${sid}" style="color:blue"> EDIT STORY </a> IN INDIAN LANGUAGES.`
    if( isMobile.iOS() ) document.getElementById("apptext").innerHTML = `DOWNLOAD <a href="https://apps.apple.com/ml/app/indic-keyboard-swalekh-flip/id1212717313" style="color:blue">SWALEKHA</a> KEYBOARD & <a href="<?php echo base_url().$this->uri->segment(1);?>/series_story/${sid}" style="color:blue"> EDIT STORY </a> IN INDIAN LANGUAGES.`
...
function mobileseriesedit(sid){
    if( isMobile.Android() ) document.getElementById("apptext").innerHTML = `DOWNLOAD <a style="color:blue;" href="https://play.google.com/store/apps/details?id=com.google.android.apps.inputmethod.hindi&hl=en_IN">GOOGLE INDIC</a> KEYBOARD & <a href="<?php echo base_url().$this->uri->segment(1);?>/series_series/${sid}" style="color:blue"> EDIT STORY </a> IN INDIAN LANGUAGES.`
    if( isMobile.iOS() ) document.getElementById("apptext").innerHTML = `DOWNLOAD <a href="https://apps.apple.com/ml/app/indic-keyboard-swalekh-flip/id1212717313" style="color:blue">SWALEKHA</a> KEYBOARD & <a href="<?php echo base_url().$this->uri->segment(1);?>/series_series/${sid}" style="color:blue"> EDIT STORY </a> IN INDIAN LANGUAGES.`
    if( isMobile.Windows() ) document.getElementById("apptext").innerHTML = `OPEN SITE ON DESKTOP`
}
</script>