            	...
            	<div class="card">
        			...
        			<a href="<?php echo base_url($this->uri->segment(1).'/series/'.preg_replace('/\s+/', '-', $rlseriesrow->title).'-'.$rlseriesrow->sid.'/'.preg_replace('/\s+/', '-', $rlseriesrow->title).'-'.$rlseriesrow->story_id);?>">
            			<?php if(isset($rlseriesrow->image) && !empty($rlseriesrow->image)) { ?>
            			    <img src="<?php echo base_url();?>assets/images/<?php echo $rlseriesrow->image; ?>" alt="<?php echo $rlseriesrow->title;?>" class="imageme">
            			<?php }else{ ?>
            		...
            		<div class="flextest">
            			<font class="byname">By<font class="namehere"><a href="<?php echo base_url($this->uri->segment(1).'/'.$rlseriesrow->profile_name);?>" style="color:#000"> <?php echo $rlseriesrow->name;?></a></font></font><br>
            		</div>
        		...
        		<?php $i = 0; foreach($rllife->result() as $rlliferow) { if($i < 3){ ?>
        			<div class="card1">
        				...
        				<div class="flextest">
        					...
        					<?php } else { ?>
        						<font class="byname">By<font class="namehere"><a href="<?php echo base_url().$this->uri->segment(1).'/'.$rlliferow->profile_name;?>" style="color:#000"> <?php echo $rlliferow->name;?></a></font></font>
        						<br>
        					<?php } ?>
        				</div>
