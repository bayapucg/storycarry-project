		        ...
		        <div id="StoryConta" class="StoryCont" style="text-align:left;">
    				...
    				<?php foreach($adminchoices->result() as $adminchoice) { ?>
    					<div class="card">
    						...
    						<a href="<?php echo base_url($this->uri->segment(1).'/story/'.preg_replace('/\s+/', '-', $adminchoice->title).'-'.$adminchoice->sid);?>" class="imagess-style">
		        ...
		        <div id="StoryContyn" class="StoryCont" style="text-align:left;">
    				...
    				<?php } if($yournetworks->num_rows() >= 7){ ?>
    					<div class="card" style="justify-content: center">
    					    <a href="<?php echo base_url().$this->uri->segment(1);?>/viewallyournetwork" style="padding:150px 0px;">
				    ...
				    <div id="story-slider" class="story-slider series">
        				<?php foreach($top_get_series->result() as $topseriesrow) { ?>
        					<div class="card">
    							...
    							<a href="<?php echo base_url($this->uri->segment(1).'/series/'.preg_replace('/\s+/', '-', $topseriesrow->title).'-'.$topseriesrow->sid.'/'.preg_replace('/\s+/', '-', $topseriesrow->title).'-'.$topseriesrow->story_id);?>" class="imagess-style">
        						...
        						<div class="flextest">
        							<font class="byname">By<font class="namehere">
        							    <a href="<?php echo base_url($this->uri->segment(1).'/'.$topseriesrow->profile_name);?>" style="color:#000">
        							        <?php echo $topseriesrow->name;?></a></font>
        							</font><br>
        						</div>
        						<div class="flextest" style="padding-top:4px;">
        							<font class="episodes">
        			    ...
        			    <?php } if($top_get_series->num_rows() >= 7){ ?>
        					<div class="card" style="justify-content: center">
        					    <a href="<?php echo base_url().$this->uri->segment(1);?>/series/top" style="padding:150px 0px;">
            						<font class="max-lines" style="padding-left:52px">VIEW MORE</font>
            					</a>
        					</div>
    					<?php } ?>
    				...
    				<div id="story-sliderls" class="story-slider">
    					<?php foreach($get_series->result() as $seriesrow) { ?>
    						<div class="card">
    							...
    							<a href="<?php echo base_url($this->uri->segment(1).'/series/'.preg_replace('/\s+/', '-', $seriesrow->title).'-'.$seriesrow->sid.'/'.preg_replace('/\s+/', '-', $seriesrow->title).'-'.$seriesrow->story_id);?>" class="imagess-style">
    							...
    							<div class="flextest">
    								<font class="byname">By<font class="namehere">
    								    <a href="<?php echo base_url($this->uri->segment(1).'/'.$seriesrow->profile_name);?>" style="color:#000">
    								        <?php echo $seriesrow->name;?></a></font>
    								</font><br>
    							</div>
    							<div class="flextest" style="padding-top:4px;">
    								<font class="episodes">
    					...
    					<?php } if($get_series->num_rows() >= 7) { ?>
    						<div class="card" style="justify-content: center">
    						    <a href="<?php echo base_url().$this->uri->segment(1);?>/series/latest" style="padding:150px 0px;">
        							<font class="max-lines" style="padding-left:52px">VIEW MORE</font>
        						</a>
    						</div>
    					<?php } ?>
		...
		<div class="main-container">
			...
			<div>
				<div id="StoryContts" class="StoryCont" style="text-align:left;">
							...
							<div class="flextest">
								<font class="byname">By<font class="namehere">
								    <a href="<?php echo base_url($this->uri->segment(1).'/'.$topstorysrow->profile_name);?>" style="color:#000">
								        <?php echo $topstorysrow->name;?></a></font>
							    </font><br>
							</div>
							<div class="flextest" style="padding-top:4px;">
								<font class = "episodes">
					...
					<?php } if($top_get_storys->num_rows() >= 7){ ?>
						<div class="card" style="justify-content: center">
						    <a href="<?php echo base_url().$this->uri->segment(1);?>/stories/top" style="padding:150px 0px;">
    							<font class="max-lines" style="padding-left:52px">VIEW MORE</font>
    						</a>
						</div>
					<?php } ?>
		        ...
		        <div id="StoryConttsl" class="StoryCont" style="text-align:left;">
    				...
    				<?php foreach($get_storys->result() as $storysrow) { ?>
    					<div class="card">
    						...
    						<a href="<?php echo base_url($this->uri->segment(1).'/story/'.preg_replace('/\s+/', '-', $storysrow->title).'-'.$storysrow->sid);?>" class="imagess-style">
    						...
    						<div class="flextest">
    							<font class="byname">By<font class="namehere">
    							    <a href="<?php echo base_url($this->uri->segment(1).'/'.$storysrow->profile_name);?>" style="color:#000">
    							        <?php echo $storysrow->name;?></a></font>
    						    </font><br>
    						</div>
    						<div class="flextest" style="padding-top:4px;">
    							<font class="episodes">
    				...
    				<?php } if($get_storys->num_rows() >= 7){ ?>
    					<div class="card" style="justify-content: center">
    					    <a href="<?php echo base_url().$this->uri->segment(1);?>/stories/latest" style="padding:150px 0px;">
        						<font class="max-lines" style="padding-left:52px">VIEW MORE</font>
        					</a>
    					</div>
    				<?php } ?>
				...
				<div id="story-sliderl" class="story-slider" >
						...
						<div class="card1">
							...
							<div class="flextest">
								<?php if(($topliferow->writing_style == 'anonymous') && ($topliferow->type == 'life')){ ?>
									<font class="byname">By<font class="namehere">
									    Anonymous</font></font><br>
								<?php } else { ?>
									<font class="byname">By<font class="namehere">
									    <a href="<?php echo base_url($this->uri->segment(1).'/'.$topliferow->profile_name);?>" style="color:#000">
									        <?php echo $topliferow->name;?></a>
									    </font>
								    </font><br>
								<?php } ?>
							</div>
					...
					<?php } $i++;}if($top_get_life->num_rows() >= 5) { ?>
						<div class="card1" style="justify-content: center">
						    <a href="<?php echo base_url().$this->uri->segment(1);?>/lifeevents/top" style="padding:140px 0px;">
		    ...
		    <div id="StoryContll" class="StoryCont" >
			    <div id="story-sliderll" class="story-slider" >
					<?php $i = 0; foreach($get_life->result() as $liferow) { if($i < 5){ ?>
						<div class="card1">
							...
							<div class="flextest">
								...
								<?php } else { ?>
									<font class="byname">By<font class="namehere">
									    <a href="<?php echo base_url($this->uri->segment(1).'/'.$liferow->profile_name);?>" style="color:#000">
									        <?php echo $liferow->name;?></a>
									    </font>
									</font><br>
								<?php } ?>
							</div>
					...
					<?php } $i++; } if($get_life->num_rows() >= 5){ ?>
						<div class="card1" style="justify-content: center">   
						    <a href="<?php echo base_url().$this->uri->segment(1);?>/lifeevents/latest" style="padding:140px 0px;">
						        <font class="max-lines" style=" text-align:center;">VIEW MORE</font>
					        </a>
						</div>
					<?php } ?>
		    ...
		    <div id="StoryContn" class="StoryCont">
				<div id="story-slidern" class="story-slider">
					...
					<div class="nano-stories" style="justify-content: center">
					    <a href="<?php echo base_url().$this->uri->segment(1);?>/shortstories" style="padding:168px 0px;">
						    <font class="max-lines" style=" text-align:center;">VIEW MORE</font>
					    </a>
					</div>
					<?php } ?>
    	    ...
    	    <div class="titleindex" style="clear:both;">
                ...
                <div id="StoryContw" class="StoryCont" style="">
    	            <div id="story-sliderw" class="story-slider" >
						...
						<div class="card1" style="justify-content: center">
						    <a href="<?php echo base_url().$this->uri->segment(1);?>/writers" style="padding:90px 0px;">
    							<font class="max-lines" style=" text-align:center;">VIEW MORE</font>
    						</a>
						</div>
					<?php } ?>
