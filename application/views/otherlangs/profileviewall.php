					        ...
					        <div class="row pt-0">
    							...
    							<div class="col-sm-4 col-xs-4 col-md-4 col-lg-2 border-right pd-0">
        							<div class="description-block">
        								...
        								<span class="description-text"><?php if(isset($profilemenu['writings']) && !empty($profilemenu['writings'])){ echo $profilemenu['writings']; } else{ ?>WRITINGS<?php } ?></span>
        							</div>
    							</div>
    							<div class="col-sm-4 col-xs-4 col-md-4 col-lg-2 border-right pd-0">
        							<div class="description-block">
        								<a href="#" data-toggle="modal" data-target="#modal-defaultf">
            								...
            								<span class="description-text"><?php if(isset($profilemenu['followers']) && !empty($profilemenu['followers'])){ echo $profilemenu['followers']; } else { ?>FOLLOWERS<?php } ?></span>
        								</a>
        							</div>
    							</div>
								<!-- Modelpop up -->
    									...
    									<div class="modal-content modalf">
        									<div class="modal-body" style="padding:0">
    											<ul class="nav nav-tabs">
    												...
    												<li><a href="#tab_2" data-toggle="tab"><b><?php if(isset($profilemenu['followingtab']) && !empty($profilemenu['followingtab'])){ echo $profilemenu['followingtab']; } else { ?>FOLLOWING<?php } ?></b></a></li>
											            ...
											            <div class="box-header with-border">
												            <div class="row" style="margin:0 -10px;" id="fersloadmore">
													            <?php if(isset($followers_names) && ($followers_names->num_rows() > 0)){
												                    ...
												                    <?php } } else { ?>
													                    <center> <h3> This user is not following anyone. </h3></center>
                   									            <?php } ?>
												            </div>
    							...
    							<div class="col-sm-4 col-xs-4 col-md-2 border-right profile1">
        							<div class="description-block">
                                        ...
                                        <span class="description-text"><?php if(isset($profilemenu['views']) && !empty($profilemenu['views'])){ echo $profilemenu['views']; } else { ?>VIEWS<?php } ?></span>
        							</div>
        						</div>
    							...
    							<div class="col-sm-4 col-xs-4 col-md-4 col-lg-3 pd-0">
        							...
        							<div class="description-block  profile1" style="float:right; margin-top:14px; cursor:pointer;">
        								<a href="<?php echo base_url().$this->uri->segment(1);?>/my_profile/<?php echo $this->session->userdata['logged_in']['user_id'];?>" style="color:#fff;" class="btn btn-successv"><?php if(isset($profilemenu['edit_profile']) && !empty($profilemenu['edit_profile'])){ echo $profilemenu['edit_profile']; } else { ?>EDIT PROFILE<?php } ?></a>
        							</div>
                ...
                <div class="sidebar side1">
                    <?php if(isset($writer_profile) && ($writer_profile->num_rows() > 0)){ foreach($writer_profile->result() as $row) {
                        ...
                        <div class="box box-widget widget-user vjc">
        				    <h4><?php if(isset($profilemenu['contact']) && !empty($profilemenu['contact'])){ echo $profilemenu['contact']; } else { ?>Contact<?php } ?></h4>
            			...
            			<div class="box box-widget widget-user vjc">
        					<h4><?php if(isset($profilemenu['about']) && !empty($profilemenu['about'])){ echo $profilemenu['about']; } else { ?>About<?php } ?></h4>
        					<p><?php echo $row->aboutus; ?></p>
        				</div>
                        <?php }else{ ?>
        			    <div class="box box-widget widget-user vjc"> <h4><?php if(isset($profilemenu['about']) && !empty($profilemenu['about'])){ echo $profilemenu['about']; } else { ?>About<?php } ?></h4>
                            <p><?php echo $row->aboutus; ?></p>
                        ...
                        <?php } ?>
        		    <?php } } ?><br>
        			<h3> <?php if(isset($profilemenu['comments_on_profile']) && !empty($profilemenu['comments_on_profile'])){ echo $profilemenu['comments_on_profile']; } else { ?>Profile Comments<?php } ?></h3>
                            ...
                            <div class="row pv-0" style="margin-top:20px;">
        			            ...
        			            <div class="col-md-6 col-xs-4">
        			            	<a href="<?php echo base_url().$this->uri->segment(1).'/'.$profile_name;?>" class="view pull-right">
        			            	    <div class="pull-right"><?php if(isset($profilemenu['back']) && !empty($profilemenu['back'])){ echo $profilemenu['back']; } else { ?>BACK<?php } ?></div>
        			            	</a>
        			            </div>
        			        </div>
                            <hr>
                            <div class="jc-m" id="loadmoreall" style="display:flex; flex-wrap:wrap; justify-content:center;">
                                <?php foreach($profileviewall->result() as $vaseriesrow){ ?>
                                    <div class="cardls">
        	                    		...
        	                    		<a href="<?php echo base_url($this->uri->segment(1).'/series/'.preg_replace('/\s+/', '-', $vaseriesrow->title).'-'.$vaseriesrow->sid.'/'.preg_replace('/\s+/', '-', $vaseriesrow->title).'-'.$vaseriesrow->story_id);?>" class="imagesls-style">
                    			...
                    			<div class="jc-m" id="loadmoreall" style="display:flex; flex-wrap:wrap; justify-content:center;">
                        			<?php foreach($profileviewall->result() as $vastorysrow) { ?>
                        		    	<div class="card">
    				                    	...
    				                    	<a href="<?php echo base_url($this->uri->segment(1).'/story/'.preg_replace('/\s+/', '-', $vastorysrow->title).'-'.$vastorysrow->sid);?>" class="imagesls-style">
                		    ...
                		    <div class=""> 
                			    <div id="loadmoreall"  style="display:flex; flex-wrap:wrap;" class="jsw jc-m">
                                    <?php foreach($profileviewall->result() as $valiferow) { 
                        			    ...
                        			    <div class="card1">
                							<a href="<?php echo base_url($this->uri->segment(1).'/story/'.preg_replace('/\s+/', '-', $valiferow->title).'-'.$valiferow->sid);?>" class="imagelife-style">
                							...
                							<div class="flextest" style="padding-top:4px;">
                								<font class="lifeEvents-text"><?php echo mb_substr(strip_tags($valiferow->story),0,150);?> </font>
                							</div>
                        							...
                        							<li class="pull-right">
                                                        ...
                                                        <ul class="dropdown-menu list-inline dropvknano1">
                                                            <li onclick="groupsuggest(<?php echo $vamodalnanorow->sid; ?>);">
                    										    <a data-toggle="modal" data-target="#groupsuggest" href="javascript:void(0);" title="COMMUINITY"><i class="fa fa-users"></i></a>
                        									</li>
