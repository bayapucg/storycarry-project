        ...
        <div class="main-containerv">
            <div class="">
                <div class="hidden-md hidden-lg" style="margin-bottom:20px;">
                   <center>
                        <form class="form-inline my-2 my-lg-0" method="GET" id="searchpost" action="<?php echo base_url().$this->uri->segment(1);?>/search">
            ...
            <div class="cenv" style="margin-bottom:20px;">
                <ul class="nav nav-pills">
	            	<li <?php if(!isset($_GET['type']) || ($_GET['type'] == '')){?>class="active"<?php } ?>>
	            	    <a href="<?php echo base_url().$this->uri->segment(1);?>/search?searchtext=<?php if(isset($searchtext)){echo $searchtext;} ?>"> ALL </a>
	            	</li>
	            	<li <?php if(isset($_GET['type']) && ($_GET['type'] == 'story')){?>class="active"<?php } ?>>
	            	    <a href="<?php echo base_url().$this->uri->segment(1);?>/searchresult?type=story&searchtext=<?php if(isset($searchtext)){echo $searchtext;} ?>"> STORIES </a></li>
	            	
	            	<li <?php if(isset($_GET['type']) && ($_GET['type'] == 'series')){?>class="active"<?php } ?>>
	            	    <a href="<?php echo base_url().$this->uri->segment(1);?>/searchresult?type=series&searchtext=<?php if(isset($searchtext)){echo $searchtext;} ?>"> SERIES </a>
	            	</li>
	            	<li <?php if(isset($_GET['type']) && ($_GET['type'] == 'life')){?>class="active"<?php } ?>>
	            	    <a href="<?php echo base_url().$this->uri->segment(1);?>/searchresult?type=life&searchtext=<?php if(isset($searchtext)){echo $searchtext;} ?>"> LIFE EVENTS </a>
	            	</li>
	            	<li <?php if(isset($_GET['type']) && ($_GET['type'] == 'people')){?>class="active"<?php } ?>>
	            	    <a href="<?php echo base_url().$this->uri->segment(1);?>/searchresultwriter?type=people&searchtext=<?php if(isset($searchtext)){echo $searchtext;} ?>"> PEOPLE </a>
	            	</li>
	            </ul>
	        </div>
            <div class="">
            	...
            	<div class="pd-0">
    		        ...
    		        <a href="<?php echo base_url().$this->uri->segment(1);?>/searchresult?type=series&searchtext=<?php if(isset($searchtext)){echo $searchtext;} ?>" class="view pull-right">
    		        ...
    		        <div id="StoryCont" class="StoryCont1" style="text-align:left;">
    				    ...
    				    <?php $i=0; foreach($get_storys->result() as $storysrow) { if($i<4){  ?>
    				    	<div class="card">
        						...
        						<div>
        							<font class="max-lines">
        								<a href="<?php echo base_url($this->uri->segment(1).'/story/'.preg_replace("~[^\p{M}\w]+~u", '-', $storysrow->title).'-'.$storysrow->sid);?>">
        						...
        						<div class="flextest">
        							<font class="byname">By<font class="namehere">
        							    <a href="<?php echo base_url($this->uri->segment(1).'/'.$storysrow->profile_name);?>" style="color:#000"> <?php echo $storysrow->name;?></a>
        							</font>
        							</font><br>
        						</div>
        						<div class="flextest" style="padding-top:4px;">
        		...
        		<div class="pd-0">
    		        ...
    		        <span class="view pull-right">
    		    	   <a href="<?php echo base_url().$this->uri->segment(1);?>/searchresult?type=life&searchtext=<?php if(isset($searchtext)){echo $searchtext;} ?>">VIEW MORE</a>
    		    	</span>
    		    	<?php } ?>
    		    </div><hr>
        		...
        		<?php if(isset($get_writer) && ($get_writer->num_rows() > 0)){ $pagestoriescount = $pagestoriescount+$get_writer->num_rows(); ?> <!--  Writers search -->
    		        <div class="pd-0">
    		            ...
    		            <a href="<?php echo base_url().$this->uri->segment(1);?>/searchresultwriter?type=people&searchtext=<?php if(isset($searchtext)){echo $searchtext;} ?>" class="view pull-right">
    		                <span class="pull-right">VIEW MORE</span>
    		            </a>
    		            <?php } ?>
    		        </div><hr>
