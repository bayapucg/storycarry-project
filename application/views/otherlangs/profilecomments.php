<?php if(isset($pro_comments) && ($pro_comments->num_rows() >0)){ foreach($pro_comments->result() as $pro_comment){ ?>
    <li class="commentdelete<?php echo $pro_comment->cid;?>">
        <div class="" style="float: left;">
            <a href="<?php echo base_url($this->uri->segment(1)."/".$pro_comment->profile_name);?>">
                <?php if(!empty($pro_comment->profile_image)){ ?>
                    <img src="<?php echo base_url();?>assets/images/<?php echo $pro_comment->profile_image;?>" style="border-radius: 50%;width:40px !important;height: 40px !important;margin-right: 10px;" alt="<?php echo ucfirst($pro_comment->name); ?>">
                <?php } else{ ?>
                    <img src="<?php echo base_url();?>assets/images/2.png" style="border-radius: 50%;width:40px !important;height: 40px !important;margin-right: 10px;" alt="<?php echo ucfirst($pro_comment->name); ?>">
                <?php } ?>
            </a>
        </div>
        <div class="comment_right clearfix">
            <div class="comment_info" style="padding-left:10px;">
                <a href="<?php echo base_url($this->uri->segment(1)."/".$pro_comment->profile_name);?>"><?php echo ucfirst($pro_comment->name); ?></a>
                <span class="dropdown" style="float:right;">
                    ...
                    <ul class="dropdown-menu pull-right">
                        ...
                        <li><a href="javascript:void(0);"><span onClick="editpro_comment(<?php echo $pro_comment->cid;?>);"><i class="fa fa-pencil"></i> EDIT</span></a></li>
                        <li><a href="javascript:void(0);"><span onClick="deletepro_comment(<?php echo $pro_comment->cid;?>);"><i class="fa fa-trash"></i> DELETE</span></a></li>
                ...
                <div style="color:#777; font-size:11px;"><?php echo get_ydhmdatetime($pro_comment->date);?></div>
            </div>
            <p style="margin: 10px 0px 2px 0px;" class="pcomment<?php echo $pro_comment->cid;?>"><?php echo $pro_comment->pro_comment; ?></p>
    ...
    </li> <hr style="margin-top:0px; margin-bottom:8px;">
<?php } } ?>