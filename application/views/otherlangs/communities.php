            			...
            			<div class="card-community" style="padding-bottom: 10px;">
                			<div class="box box-widget" style="border-radius:5px;">
                				<div class="box-body" style="padding:0px;">
                				    <a href="<?php echo base_url().$this->uri->segment(1);?>/community/<?php echo preg_replace('/\s+/', '-', $row->gener);?>">
                				...
                				<div class="box-footer box-comments" style="border-radius:0 0 5px 5px;">
                					<div class="box-comment">
                		                <div class="comment-text">
                		                    <a href="<?php echo base_url().$this->uri->segment(1);?>/community/<?php echo preg_replace('/\s+/', '-', $row->gener);?>" style="float:left;">
                				...
                				<div class="box-footer box-comments" style="border-radius:0 0 5px 5px;">
                					<div class="">
                		                <div class="comment-text">
                		                	...
                		                	<form action="<?php echo base_url().$this->uri->segment(1);?>/communities_joinform" method="POST">
    ...
    $(document).ready(function(){ // without login load more
        ...
        function load_country_data(limit, start) {
            ...
            if((sessionid == 0) || (sessionid == '') || (sessionid == 'undefined')){
                $.ajax({
                    url:'<?php echo base_url().$this->uri->segment(1);?>/loadcommunities',
                    method:"POST",
...
<script>
    $(document).ready(function(){ // featured communities load more
        ...
        function fload_country_data(flimit, fstart) {
            ...
            if(sessionid){
                $.ajax({
                    url:'<?php echo base_url().$this->uri->segment(1);?>/floadcommunities',
                    method:"POST",
...
<script>
    $(document).ready(function(){ //joined communities loadmore
        ...
        function jload_country_data(jlimit, jstart) {
            ...
            if(sessionid){
                $.ajax({
                    url:'<?php echo base_url().$this->uri->segment(1);?>/jloadcommunities',
                    method:"POST",
