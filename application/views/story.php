...
<html lang="en">
    ...
    <body>
        ...
        <form action="<?php echo base_url();?>story_story_uplode" onsubmit="return validateForm()" name="infoForm" method="post" enctype="multipart/form-data">
            <div class="write-nav">
                ...
                <div class="info">
                    ...
                    <div class="formgroup">
                        ...
                        <select name="language" required="" id="languageDropDown" onchange="javascript:languageChangeHandler()">
                            ...
                            <option value="<?php echo $key->code; ?>" <?php if(set_value('language') == $key->code){ echo 'selected'; }else if(($key->code == $sesslang) && (set_value('language') == "")){ echo 'selected';} ?>><?php echo $key->language; ?></option>
                            <?php } } ?>
                        </select>
                    ...
                    <div class="formgroup">
                        ...
                        <input type="text" id="title" name="title" required placeholder="Enter your story title" style="border: 1px solid #ccc;" value="<?php echo set_value('title');?>" autocomplete="off">
                    ...
                    <div class="formgroup" id="etitlestyle" style="<?php if(isset($sesslang) && ($sesslang != 'en')){ }else{ echo 'display:none;'; } ?>">
                        ...
                        <input type="text" id="etitle" name="etitle" placeholder="Re-enter your story title in english" value="<?php echo set_value('etitle');?>" <?php if(isset($sesslang) && ($sesslang == 'en')){ }else{ echo 'required'; } ?> style="border: 1px solid #ccc;" autocomplete="off">
...
<script>
    $( document ).ready(function() {
        var etlanguage = document.forms["infoForm"]["languageDropDown"];
        var etlanguageval = etlanguage.options[etlanguage.selectedIndex].value;
        if(etlanguageval != 'en'){ 
        $('#etitlestyle').css('display', 'block');
        }
