...
/*Left*/
    ...
    <div class="login dropdown profile">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"> 
            ...
            <?php } else { ?>
            	<img src="<?php echo base_url();?>assets/images/2.png" class="img-circlep" alt="user name">
            <?php } ?>
		</a>
    ...
    <div class="nav-items">
		<div class="dropdown" style="border-left:none;">
		    ...
		    if(isset($selectedlang) && ($selectedlang == 'en')){ ?>
		        <a href="javascript:void(0);" class="dropdown-toggle" title="ENGLISH" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"> 
		    ...
		    <?php } else if(isset($languages) && ($languages->num_rows() > 0)){
		        foreach($languages->result() as $language ){ if($language->langname == $this->uri->segment(1)){ ?>
        			<a href="javascript:void(0);" class="dropdown-toggle" title="<?php echo $language->language;?>" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"> 
    			...
    			<ul class="dropdown-menu pull-left" style="right:0!important; left:auto;">
    			    <?php foreach($languages->result() as $language ){ ?>
        				<li style="border-bottom:1px solid #f4f4f4;">
        				    <a class="dropk" style="padding:5px 10px; <?php if(isset($selectedlang) && ($selectedlang == $language->code)){ ?>color:red !important;    background: none;<?php } ?>" href="<?php echo base_url();?><?php echo $language->langname;?>" title="<?php echo $language->language;?>"><?php echo $language->language;?></a>
        				</li>
                    <?php } ?>
                </ul>
            <?php } ?>
									...
									<li>
									    <a href="<?php echo base_url().$notseennotify->profile_name;?>" style="padding-top:0px;">
    										<div class="user-block user-blockv" style="border-left:none;">
    											...
    											<?php } else{ ?> 
    												<img src="<?php echo base_url();?>assets/images/2.png" class="user-blockv-img" alt="<?php echo $notseennotify->sname;?>">
    											<?php } ?>
									...
									<li>
										<a href="<?php echo base_url().$notseennotify->redirect_uri;?>" style="padding-top:0px;">
											<div class="user-block user-blockv" style="border-left:none;">
    											...
    											<?php } ?>
    												<b class="user-blockv-title"><?php echo $notseennotify->sname;?> </b>
    											<span style="color:#333;">subscribed to your series</span>
    												<b class="user-blockv-title"><?php echo $notseennotify->stitle;?></b><br> 
    											<span class="user-blockv-span">
    											<?php echo date("F j, Y g:i A", strtotime($notseennotify->created_at));?></span>
    										</div>
									...
									<li>
										<a href="<?php echo base_url().$seennotify->profile_name;?>" style="padding-top:0px;">
											<div class="user-block user-blockv" style="border-left:none;">
    											...
    											<?php } else{ ?> 
    												<img src="<?php echo base_url();?>assets/images/2.png" class="user-blockv-img" alt="<?php echo $seennotify->sname;?>">
    											<?php } ?>
										...
										<a href="<?php echo base_url().$seennotify->redirect_uri;?>" style="padding-top:0px;">
											<div class="user-block user-blockv" style="border-left:none;">
    											...
    											<span style="color:#333;">subscribed to your series 
    												<b class="user-blockv-title"><?php echo $seennotify->stitle;?></b></span><br>
    											<span class="user-blockv-span">
    											<?php echo date("F j, Y g:i A", strtotime($seennotify->created_at));?></span>
    										</div>
										</a>
		...
		<div class="dropdown" style="border-left:none; width:50px; padding-top:6.5px; background:none;">
			<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true" style="width: 45px; height:45px; vertical-align: middle; padding-top:0px;"> 
				...
				<?php if(isset($this->session->userdata['logged_in']['profile_image']) && 
					!empty($this->session->userdata['logged_in']['profile_image'])) { ?>
					<img src="<?php echo base_url();?>assets/images/<?php echo $this->session->userdata['logged_in']['profile_image']; ?>" style="width:100%; height:100%;" class="img-circle" alt="<?php if($this->session->userdata['logged_in']['name']){ echo $this->session->userdata['logged_in']['name']; } ?>">
				<?php } else { ?>
					<img src="<?php echo base_url();?>assets/images/2.png" style="width:100%; height:100%;" class="img-circle" alt="User Name">
				<?php } ?>
			</a>
    ...
    <div class="lang hidden-lan">
        ...
        <div class="dropdown">
		    <?php $selectedlang = get_langshortname($this->uri->segment(1));
		    if(isset($selectedlang) && ($selectedlang == 'en')){ ?>
		        <a href="javascript:void(0);" class="dropdown-toggle" title="WRITE" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true" style="color:#fff;">  
    		        <i class="fa fa-language" aria-hidden="true"></i>
    		    </a>
		    <?php } else if(isset($languages) && ($languages->num_rows() > 0)){
		        foreach($languages->result() as $language ){ if($language->langname == $this->uri->segment(1)){ ?>
