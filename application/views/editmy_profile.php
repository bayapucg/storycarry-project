        							...
        							<div style="height:250px; background-color:rgba(0, 0, 0, 0.55); background-repeat: no-repeat;background-size: cover; padding: 60px 30px;">
            							<div class="widget-user-image" style="float:left;">
                                            ...
                                            <label class="pull-left">
                                                <a href="<?php echo base_url();?>welcome/removeprofilepic/<?php echo $row->user_id;?>" class="btn btn-default pos_ab" title="Delete"><i class="fa fa-camera" aria-hidden="true"></i></a>
                                            </label>
                                        </div>
                                        ...
                                        <label class="" style="background:none!important; color:#fff; float:right; margin-top: 35px;" for="upload-file-selector">
            								...
            								<a href="<?php echo base_url();?>welcome/removeprofilecover/<?php echo $row->user_id;?>" class="btn btn-default" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
            							</label>
