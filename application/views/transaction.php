...
<script>
    $(function() {
        $('input[name="paymenttype"]').change(function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>welcome/paymenttype",
    ...
    function paymentdetailscheck(value){
        ...
        if((paymenttype) && (value)){
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>welcome/paymentdetailscheck",
    ...
    /*function paymentdetails(value){
        var paymenttype = $("input[name='paymenttype']:checked").val();
        if((paymenttype == value) && (value == 'paytm')){
            var paytmphone = $('#paytmphone').val();
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>welcome/paymentdetails",
                data: {'paymenttype': value, 'paytmphone': paytmphone},
                dataType: 'json',
                success: function(result) {
        ...
        }else if((paymenttype == value) && (value == 'bankaccount')){
            var accountno = $('#accountno').val();
            var ifsccode = $('#ifsccode').val();
            var bankname = $('#bankname').val();
            var accounteename = $('#accounteename').val();
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>welcome/paymentdetails",
                data: {'paymenttype': value, 'accountno': accountno, 'ifsccode': ifsccode, 'bankname': bankname, 'accounteename':accounteename},
                dataType: 'json',
                success: function(result) {
                    $('span.text-danger').text('');
                    if(result.status == -1){
    ...
    function requestformoney(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>welcome/requestformoney",
            data: {'paymenttype': paymenttype},
            success: function(data) {
                if(data == 1){
...
<script>
    $("#monetisation").change(function() {
        if($(this).prop('checked')) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>welcome/monitizeonreq",
                success: function(data) {
                    if(data == 2){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>welcome/monitizeoffreq",
                success: function(data) {
                    if(data == 1){
    ...
    $(".checkrow").click(function () {
        ...
        if($(this).prop('checked')) {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>welcome/storymonitizeonreq",
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>welcome/storymonitizeoffreq",
                data: { 'storyid': storyid},
                success: function(data) {
                    if(data == 1){
    ...
    function viewtrans(){
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>welcome/translist",
            dataType: 'json',
            success: function(data) {
                if(data != 0){
                    var trans = '';
