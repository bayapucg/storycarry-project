    ...
    <?php foreach ($profilealloadmore->result() as $valoadseriesrow) { ?>
        <div class="cardls">
			<div class="book-typels"><?php echo $valoadseriesrow->gener;?></div>
				<a href="<?php echo base_url('series/'.preg_replace("~[^\p{M}\w]+~u",'-', $valoadseriesrow->title).'-'.$valoadseriesrow->sid.'/'.preg_replace("~[^\p{M}\w]+~u",'-', $valoadseriesrow->title).'-'.$valoadseriesrow->story_id);?>" class="imagesls-style">
			...
			<div>
				<font class="max-linesls">
					...
					<a href="<?php echo base_url('series/'.preg_replace("~[^\p{M}\w]+~u",'-', $valoadseriesrow->title).'-'.$valoadseriesrow->sid.'/'.preg_replace("~[^\p{M}\w]+~u",'-', $valoadseriesrow->title).'-'.$valoadseriesrow->story_id);?>">
			...
			<div class="flextestls">
				<font class="bynamels">By <font class="namehere">
				    <a href="<?php echo base_url($valoadseriesrow->profile_name);?>" style="color:#000"> <?php echo $valoadseriesrow->name;?></a>
				</font></font><br>
			</div>
    ...
    <?php foreach ($profilealloadmore->result() as $valoadstorysrow) { ?>
        <div class="cardls">
			<div class="book-typels"><?php echo $valoadstorysrow->gener;?></div>
				<a href="<?php echo base_url('story/'.preg_replace("~[^\p{M}\w]+~u",'-', $valoadstorysrow->title).'-'.$valoadstorysrow->sid);?>" class="imagesls-style">
			...
			<div>
				<font class="max-linesls">
					<a href="<?php echo base_url('story/'.preg_replace("~[^\p{M}\w]+~u",'-', $valoadstorysrow->title).'-'.$valoadstorysrow->sid);?>">
			...
			<div class="flextestls">
				<font class="bynamels">By <font class="nameherels" style="padding:1px;">
				    <a href="<?php echo base_url($valoadstorysrow->profile_name);?>" style="color:#000"> <?php echo $valoadstorysrow->name;?></a>
				</font></font><br>
			</div>
			<div class="flextestls" style="padding-top:4px;">
			   	<font class = "episodesls">
			...
			<div class="flextest">
				...
				<?php } else { ?>
					<font class="byname">By <font class="namehere">
					    <a href="<?php echo base_url().$valiferow->profile_name; ?>" style="color:#000"> <?php echo $valiferow->name;?></a></font></font>
					<br>
				<?php } ?>
			</div>
			<div class="flextest" style="padding-top:4px;">
				<font class="lifeEvents-text"><?php echo substr(strip_tags($valiferow->story),0,150);?> 
					<a href="<?php echo base_url('story/'.preg_replace("~[^\p{M}\w]+~u",'-', $valiferow->title).'-'.$valiferow->sid);?>"></a>
				</font>
			</div>
