    ...
    $(document).ready(function(){
        ...
        $('#cropbox').Jcrop({
            ...
            onSelect: function(c){
                ...
                //$("#cropped_img").show();
                $.ajax({
        			url: "<?php echo base_url();?>index.php/welcome/image_crop",
        			type: 'POST',
        ...
        $("#crop").click(function(){
            ...
            //$("#cropped_img").attr('src','<?php echo base_url();?>index.php/welcome/image_crop?x='+size.x+'&y='+size.y+'&w='+size.w+'&h='+size.h+'&img='+img);
            
            //$(".img-circle").attr('src','<?php echo base_url();?>index.php/welcome/image_crop?x='+size.x+'&y='+size.y+'&w='+size.w+'&h='+size.h+'&img='+img);
        });
    });
</script>