            ...
            <?php if(isset($genertopstories) && ($genertopstories->num_rows() > 0)){ 
    		    ...
    		    <div class="row pt-0">
    			    ...
    			    <div class="col-md-6 col-xs-4 pd-0">
    			    	...
    			    	<a href="<?php echo base_url();?>genre/<?php echo $this->uri->segment(2);?>/top">
    				...
    				<div id="story-slider" class="story-slider series">
    			        <?php $i = 0; foreach($genertopstories->result() as $topstorysrow) { if($i < 4){ ?>
    			            <div class="card">
    				        	...
    				        	<div class="flextest">
    				        		<font class="byname">By<font class="namehere"><a href="<?php echo base_url($topstorysrow->profile_name);?>" style="color: #000;"> <?php echo $topstorysrow->name;?></a></font></font><br>
    				        	</div>
        			...
        			<?php foreach($generstories->result() as $storysrow) { ?>
            			<div class="cardls">
    			        	...
    			        	<div class="flextestls">
    			        		<font class="bynamels">By<font class="namehere"><a href="<?php echo base_url($storysrow->profile_name);?>" style="color: #000;"> <?php echo $storysrow->name;?></a></font></font><br>
    			        	</div>
