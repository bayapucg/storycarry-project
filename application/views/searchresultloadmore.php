	    ...
	    <div class="card">
			...
			<div class="flextest">
				<font class="byname">By<font class="namehere">
				    <a href="<?php echo base_url($seriesrow->profile_name);?>" style="color:#000"><?php echo $seriesrow->name;?></a></font>
				</font><br>
			</div>
	...
	<?php } } else if(isset($loadsearchresults) && ($loadsearchresults->num_rows() > 0) && ($_GET['type'] == 'story')){
        ...
        foreach($loadsearchresults->result() as $storyrow) { ?>
	        <div class="card">
				...
				<div>
					<font class="max-lines">
						<a href="<?php echo base_url('story/'.preg_replace("~[^\p{M}\w]+~u", '-', $storyrow->title).'-'.$storyrow->sid);?>">
				...
				<div class="flextest">
					<font class="byname">By<font class="namehere">
					    <a href="<?php echo base_url($storyrow->profile_name);?>" style="color:#000"><?php echo $storyrow->name;?></a></font>
					</font><br>
				</div>
				<div class="flextest" style="padding-top:4px;">
					<font class = "episodes">
    ...
    <?php } } else if(isset($loadsearchresults) && ($loadsearchresults->num_rows() > 0) && ($_GET['type'] == 'life')){
        ...
        foreach($loadsearchresults->result() as $liferow) { ?>
			<div class="card1">
				...
				<div>
    				<font class="max-lines">
    					<a href="<?php echo base_url('story/'.preg_replace("~[^\p{M}\w]+~u", '-', $liferow->title).'-'.$liferow->sid);?>"><?php echo $liferow->title;?></a>
    				</font> 
				</div>
				<div class="flextest">
