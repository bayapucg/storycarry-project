    ...
    <div class="box box-widget" style="background:#fff; border:1px solid #dddddd;margin-bottom: 10px;" id="delcomm<?php echo $key->id;?>">
    	<div class="box-header with-border">
			<div class="user-block">
				...
				<span class="username"><a href="<?php echo base_url().$key->profile_name; ?>">
					...
					<div class="box-footer box-comments editdelete<?php echo $comment->id;?>" style="padding-bottom:0px;">
						<div class="box-comment">
							...
							<div class="comment-text">
								<span class="username" style="padding-top:6px;">&nbsp; <a href="<?php echo base_url().$comment->profile_name; ?>">
	...
	<div class="box box-widget" style="background:#fff; border:1px solid #dddddd;margin-bottom: 10px;" id="delcomm<?php echo $yourfeed->id;?>">
		<div class="box-header with-border">
			<div class="user-block">
				...
				<span class="username"><a href="<?php echo base_url().$yourfeed->profile_name; ?>">
				...
				<?php foreach($comments->result() as $ycomment){ ?>
					<div class="box-footer box-comments editdelete<?php echo $ycomment->id;?>">
						<div class="box-comment">
							...
							<div class="comment-text">
								<div class="comment-text">
									<span class="username" style="padding-top:6px;">&nbsp; <b><a href="<?php echo base_url().$ycomment->profile_name; ?>">
    ...
    <div class="box box-widget" style="background:#fff; border:1px solid #dddddd;margin-bottom: 10px;">
        <div class="box-header with-border">
    		<div class="user-block">
    			...
    			<span class="username"><a href="<?php echo base_url().$storyfeed->profile_name; ?>">
    				...
    				<div class="box-comment">
                        ...
                        <div style="margin:8px 0 6px 2px" class="comment-text">
    					    <?php if(strlen($fscomment->comment) > 200){ ?>
						        <div class="fsmore <?php echo $fscomment->cid;?>" style="word-wrap: break-word;"><?php echo mb_substr($fscomment->comment, 0, 200); ?>
						            <span class="showhide<?php echo $fscomment->cid;?>" style="display:none;"><?php echo mb_substr($fscomment->comment,200); ?></span>
						            <u onclick="showhide(<?php echo $fscomment->cid;?>)" class="moreless<?php echo $fscomment->cid;?>" style="cursor: pointer;">Read More</u></div>
						    <?php } else{ ?>
    					        ...
    					        <span class="media-body bodycv">
    						        <div class="">
                                        ...
                                        <?php if(strlen($fssubcomment->comment) > 200){ ?>
									        <span class="fsmore <?php echo $fssubcomment->cid;?>" style="word-wrap: break-word;padding-left:10px;"><?php echo mb_substr($fssubcomment->comment, 0, 200); ?>
									            <span class="showhide<?php echo $fssubcomment->cid;?>" style="display:none;"><?php echo mb_substr($fssubcomment->comment,200); ?></span>
									            <u onclick="showhide(<?php echo $fssubcomment->cid;?>)" class="moreless<?php echo $fssubcomment->cid;?>" style="cursor: pointer;">Read More</u></span>
									    <?php } else{ ?>
