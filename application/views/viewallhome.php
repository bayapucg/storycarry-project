...
<div class="content-wrapper">
    <section class="content">
        <?php if(isset($viewallhome) && ($viewallhome->num_rows() > 0) && (($this->uri->segment(2) == 'series') || (($this->uri->segment(1) == 'series') && ($this->uri->segment(2) == 'latest')) ) ){ ?>
    			...
    			<?php foreach($viewallhome->result() as $topseriesrow) { ?>
        			<div class="cardls">
            			...
            			<div class="flextestls">
            				<font class="bynamels">By <font class="nameherels"><a href="<?php echo base_url($topseriesrow->profile_name);?>" style="color:#000"> <?php echo $topseriesrow->name;?></a></font></font><br>
            			</div>
        ...
        <?php } else if(isset($viewallhome) && ($viewallhome->num_rows() > 0) && (($this->uri->segment(2) == 'story') || (($this->uri->segment(1) == 'stories') && ($this->uri->segment(2) == 'latest')) ) ){ ?>
        <div class="main-container1">
		    <div class="row pt-0">
			    <div class="col-md-12 col-xs-12 pd-0">
			...
			<div>
	            ...
	            <?php foreach($viewallhome->result() as $topstorysrow) { ?>
        	        <div class="cardls">
						...
						<div>
							<font class="max-linesls">
								<a href="<?php echo base_url('story/'.preg_replace("~[^\p{M}\w]+~u", '-', $topstorysrow->title).'-'.$topstorysrow->sid);?>" class="product-title"><?php echo $topstorysrow->title;?></a>
							</font> 
						</div>
        ...
        <?php } else if(isset($viewallhome) && ($viewallhome->num_rows() > 0) && (($this->uri->segment(2) == 'nano') || ($this->uri->segment(1) == 'shortstories'))){
								...
								<h3 class="name-nanostories">
								    ...
								    <span class="dropdown"  style="float:right;margin-top:-2.8px;">
    			                        ...
    			                        <ul class="dropdown-menu pull-right">
    			                            <?php if(isset($this->session->userdata['logged_in']['user_id']) && ($nanorow->user_id == $this->session->userdata['logged_in']['user_id'])){ ?>
        ...
        <?php } else if(isset($viewallhome) && ($viewallhome->num_rows() > 0) && (($this->uri->segment(2) == 'life') || (($this->uri->segment(1) == 'lifeevents') && ($this->uri->segment(2) == 'latest')) ) ){ ?>
        <div class="main-container-2">
            <!-- <div class="row pt-0">
		        <div class="col-md-6 col-xs-8 pd-0"></div>
            ...
            <div class="row pt-0">
		        ...
		        <div class="tagv" style="display:flex;">
	                ...
	                <div class="brv1 hidden-xs view" style="margin-right:0px; width:10%;background: #3c8dbc;border-radius: 3px;"><a href="<?php echo base_url();?>lifeeventtags" style="color:#fff;"> View More </a></div>
	            </div>
	            <?php } ?>
		    </div>
		    <div class="row pt-0">
...
<script>
    $(document).ready(function(){
        ...
        function load_country_data(limit, start) {
            ...
            var typeseg = "<?php echo $this->uri->segment(1);?>";
            ...
            $.ajax({
                url:'<?php echo base_url();?>viewallloadmore/'+vatype,
                method:"POST",
