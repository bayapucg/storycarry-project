		                	    ...
		                	    foreach($notifications['storynotifys']->result() as $storynotify) {
		                	        if($storynotify->type == 'writerfollow') { ?>
    		                	        <div class="user-block" style="cursor:pointer;">
    		                	            <a href="<?php echo base_url().$storynotify->profile_name;?>">
...
<script>
    function communitynotis(){
        $.ajax({
    		url: "<?php echo base_url();?>welcome/communitynotis",
    		type: 'POST',
    ...
    function suggestnotis(){
        $.ajax({
    		url: "<?php echo base_url();?>welcome/suggestnotis",
    		type: 'POST',
    		success: function (resultdata) {
    ...
    $(document).ready(function(){
        ...
        function load_country_data(limit, start) {
            $.ajax({
                url:'<?php echo base_url();?>welcome/loadnotifications',
                method:"POST",
