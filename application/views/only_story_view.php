...
<script> // comments
	...
	function postReplycomment(commentid, storyid){
	    ...
	    '<span class="input-group-btn"><button type="submit" class="btn btn-success btn-flat notloginmodal btnspinner" onclick="addreplycomment('+commentid+','+storyid+')">POST</button></span>');
