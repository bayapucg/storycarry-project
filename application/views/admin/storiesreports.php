                ...
                <?php if(isset($reports) && ($reports->num_rows() > 0)){ $i = 1; foreach($reports->result() as $reportrow){ ?>
                    <tr>
                        ...
                        <?php if(isset($reportrow->type) && (($reportrow->type == 'story') || ($reportrow->type == 'life'))){
                                $redirecturl = base_url().'telugustory/index.php/welcome/only_story_view?id='.$reportrow->story_id;
                            }elseif(isset($reportrow->type) && ($reportrow->type == 'series')){
                                 $redirecturl = base_url().'telugustory/index.php/welcome/new_series?id='.$reportrow->story_id.'&story_id='.$reportrow->story_id;
                            }else{ $redirecturl = '#'; } ?>
