        ...
        <table class="table table-condensed table-striped table-hover">
            ...
            <tbody id="usersearchsortresult">
                <?php if(isset($userslist) && ($userslist->num_rows() > 0)){ $i = 1; foreach($userslist->result() as $userrow){ ?>
                    <tr>
                        <td>#<?php echo $i;?></td>
                        <td><a href="<?php echo base_url();?>index.php/telugu_admin/profilestories/<?php echo $userrow->user_id;?>" target="_blank"><?php echo $userrow->profile_name;?></a></td>
                        ...
                        <td>
                            ...
                            <a href="<?php echo base_url();?>index.php/telugu_admin/blockprofile/<?php echo $userrow->user_id;?>"> Block </a>
                            <?php }else{ ?>
                            <a href="<?php echo base_url();?>index.php/telugu_admin/unblockprofile/<?php echo $userrow->user_id;?>"> Unblock </a>
                            <?php } ?>
                            <?php if($userrow->admin_verify == 'not_verified'){ ?>
                            <a href="<?php echo base_url();?>index.php/telugu_admin/verifyprofile/<?php echo $userrow->user_id;?>"> To be Verify</a>
                            <?php } else{ ?>
                            <a href="<?php echo base_url();?>index.php/telugu_admin/notverifyprofile/<?php echo $userrow->user_id;?>"> Verified </a>
                            <?php } ?>
                            <a href="<?php echo base_url();?>index.php/telugu_admin/deleteprofile/<?php echo $userrow->user_id;?>"  onclick="return confirm('Are you sure? Do you want to Delete the User?')"> Delete </a>
