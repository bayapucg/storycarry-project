    ...
    <div class="main">
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody id="storiessearchresults">
                <?php if(isset($removemstories) && ($removemstories->num_rows() > 0)){ $i = 1; 
                    foreach($removemstories->result() as $mstory){ if(($mstory->pay_story == 'N') && (($mstory->smonetisation == 'yes'))){ ?>
                    <tr>
                        <td>#<?php echo $i;?></td>
                        <td><a href="<?php echo base_url('index.php/welcome/only_story_view?id='.$mstory->sid); ?>" target="_blank"><?php echo $mstory->title;?></a></td>
