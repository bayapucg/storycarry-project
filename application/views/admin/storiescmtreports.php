                ...
                <?php if(isset($storiescmtreports) && ($storiescmtreports->num_rows() > 0)){ $i = 1; 
                    ...
                    <tr>
                        ...
                        <?php if(isset($storiescmtreport->type) && (($storiescmtreport->type == 'story') || ($storiescmtreport->type == 'life'))){
                                $redirecturl = base_url().'telugustory/index.php/welcome/only_story_view?id='.$storiescmtreport->story_id;
                            }elseif(isset($storiescmtreport->type) && ($storiescmtreport->type == 'series')){
                                 $redirecturl = base_url().'telugustory/index.php/welcome/new_series?id='.$storiescmtreport->story_id.'&story_id='.$storiescmtreport->story_id;
                            }else{ $redirecturl = '#'; } ?>
