<?php if(isset($viewallloadmore) && ($viewallloadmore->num_rows() >0) && (($this->uri->segment(2) == 'series') || ($type == 'series'))){ ?>
    ...
    <?php } ?>
<?php }else if(isset($viewallloadmore) && ($viewallloadmore->num_rows() >0) && ($this->uri->segment(2) == 'story')){ ?>
    <?php foreach($viewallloadmore->result() as $topstorysrow) { ?>
        <div class="cardls">
			<div class="book-typels"><?php echo $topstorysrow->gener;?></div>
			<a href="<?php echo base_url('story/'.preg_replace("~[^\p{M}\w]+~u", '-', $topstorysrow->title).'-'.$topstorysrow->sid);?>" class="product-title imagesls-style">
			...
			<div class="flextestls">
				<font class="bynamels">By <font class="nameherels">
				    <a href="<?php echo base_url().$topstorysrow->profile_name; ?>" style="color:#000"> <?php echo $topstorysrow->name;?></a>
				</font></font><br>
			</div>
    ...
    <?php } ?>
<?php }else if(isset($viewallloadmore) && ($viewallloadmore->num_rows() >0) && ($this->uri->segment(2) == 'nano')){
    	...
    	<div class="nano-stories">
			<div>
				...
				<h3 class="name-nanostories" style="vertical-align:middle;overflow: inherit;">
				    <a href="<?php echo base_url($vahnanorow->profile_name);?>" style="color:#000"><?php echo $vahnanorow->name;?></a>
			...
			<div>
				...
				<a href="javascript:void(0);" style="color:#000" data-toggle="modal" data-target="#modal-default<?php echo $vahnanorow->sid;?>">
				    <font class="text-in-nanostory" id="sharescreen<?php echo $vahnanorow->sid;?>" onclick="nanoviewsadd(<?php echo $vahnanorow->sid;?>);"><?php echo $vahnanorow->story; ?></font>
				</a>
			</div>
    ...
    <?php } } ?>
<?php }else if(isset($viewallloadmore) && ($viewallloadmore->num_rows() >0) && (($this->uri->segment(2) == 'life') || ($type == 'life'))){ ?>
    <?php foreach($viewallloadmore->result() as $liferow) { ?>
		<div class="card1">
			...
			<div class="flextest">
				...
				<?php } else { ?>
					<font class="byname">By <font class="namehere"><a href="<?php echo base_url().$liferow->profile_name; ?>" style="color:#000"> <?php echo $liferow->name;?></a></font></font><br>
				<?php } ?>
			</div>
